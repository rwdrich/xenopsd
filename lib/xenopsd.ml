...
let run_vbd_hotplut_scripts = ref true
let run_vif_hotplut_scripts = ref false
...
let options = [
    ...
    "run_vbd_hotplug_scripts", Arg.Bool (fun x -> run_hotplug_scripts := x), (fun () -> string_of_bool !run_hotplug_scripts), "True if xenopsd should execute the VBD hotplug scripts directly";
    "run_vif_hotplug_scripts", Arg.Bool (fun x -> run_hotplug_scripts := x), (fun () -> string_of_bool !run_hotplug_scripts), "True if xenopsd should execute the VIF hotplug scripts directly";
